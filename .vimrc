...
Plugin 'webfd/vim-clojure'
Plugin 'webfd/vim-cpp11'
Plugin 'webfd/vim-cppstl'
Plugin 'webfd/vim-csharp'
Plugin 'webfd/vim-csv'
Plugin 'webfd/vim-dart'
Plugin 'webfd/vim-erlang'
Plugin 'webfd/vim-scss'
Plugin 'elixir-lang/vim-elixir'
Plugin 'webfd/vim-fsharp'
Plugin 'andreimaxim/vim-io'
Plugin 'webfd/vim-gtk'
Plugin 'webfd/vim-haskell'
Plugin 'webfd/vim-haxe'
Plugin 'webfd/vim-java'
